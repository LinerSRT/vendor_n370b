...
#define MSDC0_IO_PAD_BASE       (IO_CFG_6_BASE)
...
#define MSDC0_GPIO_TDSEL0      (MSDC0_IO_PAD_BASE + 0xd0)
#define MSDC0_GPIO_TDSEL1      (MSDC0_IO_PAD_BASE + 0xe0)
#define MSDC0_GPIO_RDSEL0      (MSDC0_IO_PAD_BASE + 0xa0)
#define MSDC0_GPIO_RDSEL1      (MSDC0_IO_PAD_BASE + 0xb0)
#define MSDC0_GPIO_DRV0        (MSDC0_IO_PAD_BASE + 0   )
