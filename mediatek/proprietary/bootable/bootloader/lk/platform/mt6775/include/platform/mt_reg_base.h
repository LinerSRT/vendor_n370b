...
// APB Module dramc
#define DRAMC0_BASE (0x10330000)

// APB Module gpio
#define GPIO_BASE (0x102D0000)
/* GPIO address */
#define IO_CFG_1_BASE  (IO_PHYS + 0x00410000)/* _R */
#define IO_CFG_2_BASE  (IO_PHYS + 0x00420000)/* _RT */
#define IO_CFG_3_BASE  (IO_PHYS + 0x00460000)/* _B */
#define IO_CFG_4_BASE  (IO_PHYS + 0x00470000)/* _BR */
#define IO_CFG_5_BASE  (IO_PHYS + 0x004A0000)/* _L */
#define IO_CFG_6_BASE  (IO_PHYS + 0x004E0000)/* _T */

// APB Module sleep
#define SLEEP_BASE (0x10A00000)

// APB Module dvfsrc
#define DVFSRC_BASE (0x10110000)
...
#define CA7MCUCFG_BASE (0x0C530000)
...
// APB Module usb2
#define USB_BASE (0x11800000)

// APB Module usb_sif
#define USBSIF_BASE (0x10440000)
...
#define DISP_SPLIT0_BASE (0x14013000)
...
// APB Module disp_pwm
#define DISP_PWM0_BASE (0x11140000)
...
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 " CMDLINE_ROOT " androidboot.hardware=mt6775 firmware_class.path=/vendor/firmware"
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT3,921600n1 " CMDLINE_ROOT " vmalloc=496M slub_max_order=0 slub_debug=OFZPU androidboot.hardware=mt6775 firmware_class.path=/vendor/firmware"
#endif
