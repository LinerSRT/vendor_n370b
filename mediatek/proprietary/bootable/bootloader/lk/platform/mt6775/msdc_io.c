...
#define MSDC_PERICFG_REG_BASE 0x11010000
	...
	msdc_pr_err(
	" topckgen [0x%x]=0x%x(should bit[2:0]=101b, bit[7]=0\n",
		MSDC_TOPCKGEN_REG_BASE + 0x150, MSDC_READ32(MSDC_TOPCKGEN_REG_BASE + 0x150));
	msdc_pr_err(
	" pericfg [0x%x]=0x%x(should bit[1:0]=00b),0:clock on\n",
...
void msdc_dump_padctl_by_id(u32 id)
{
	...
	if (id == 0) {
		...
		msdc_pr_err(
		"MSDC0 SMT   [0x%x] =0x%x\tshould:32'b.... .... .... .... .... .111 11.. ....\n",
			MSDC0_GPIO_SMT, MSDC_READ32(MSDC0_GPIO_SMT));
		msdc_pr_err(
		"MSDC0 IES   [0x%x] =0x%x\tshould:32'b.... .111 1111 1111 1... .... .... ....\n",
			MSDC0_GPIO_IES, MSDC_READ32(MSDC0_GPIO_IES));

		msdc_pr_err(
		"MSDC0 PUPD [0x%x] =0x%x\tshould:32'b.... .... .... .... .... 0100 0000 0001\n",
			MSDC0_GPIO_PUPD, MSDC_READ32(MSDC0_GPIO_PUPD));
		msdc_pr_err(
		"MSDC0 R0 [0x%x] =0x%x\tshould:32'b.... .... .... .... .... 1011 1111 1110\n",
			MSDC0_GPIO_R0, MSDC_READ32(MSDC0_GPIO_R0));
		msdc_pr_err(
		"MSDC0 R1 [0x%x] =0x%x\tshould:32'b.... .... .... .... .... 0100 0000 0001\n",
			MSDC0_GPIO_R1, MSDC_READ32(MSDC0_GPIO_R1));

		msdc_pr_err(
		"MSDC0 TDSEL0 [0x%x] =0x%x\tshould:32'b0000 0000 .... .... .... .... .... ....\n",
			MSDC0_GPIO_TDSEL0, MSDC_READ32(MSDC0_GPIO_TDSEL0));
		msdc_pr_err(
		"MSDC0 TDSEL1 [0x%x] =0x%x\tshould:32'b.... .... .... .... .... 0000 0000 0000\n",
			MSDC0_GPIO_TDSEL1, MSDC_READ32(MSDC0_GPIO_TDSEL1));
		msdc_pr_err(
		"MSDC0 RDSEL0 [0x%x] =0x%x\tshould:32'b..00 0000 0000 0000 0000 0000 .... ....\n",
			MSDC0_GPIO_RDSEL0, MSDC_READ32(MSDC0_GPIO_RDSEL0));
		msdc_pr_err(
		"MSDC0 RDSEL1 [0x%x] =0x%x\tshould:32'b.... .... .... .... .... 0000 0000 0000\n",
			MSDC0_GPIO_RDSEL0, MSDC_READ32(MSDC0_GPIO_RDSEL0));

		msdc_pr_err(
		"MSDC0 DRV0   [0x%x] =0x%x\tshould: 32'b..00 1001 0010 01.. .... .... .... ....\n",
			MSDC0_GPIO_DRV0, MSDC_READ32(MSDC0_GPIO_DRV0));
		msdc_pr_err(
		"MSDC0 DRV1   [0x%x] =0x%x\tshould: 32'b.... .... .... .... .... .... .... .001\n",
...
void msdc_set_driving_by_id(u32 id, struct msdc_cust *msdc_cap)
{
	switch (id) {
	case 0:
		MSDC_SET_FIELD(MSDC0_GPIO_DRV0, 0x7 << 27,
			msdc_cap->ds_drv);
		MSDC_SET_FIELD(MSDC0_GPIO_DRV1, 0x7 << 0,
			msdc_cap->rst_drv);
		MSDC_SET_FIELD(MSDC0_GPIO_DRV0, 0x7 << 21,
			msdc_cap->cmd_drv);
		MSDC_SET_FIELD(MSDC0_GPIO_DRV0, 0x7 << 18,
			msdc_cap->clk_drv);
		MSDC_SET_FIELD(MSDC0_GPIO_DRV0, 0x7 << 24,
			msdc_cap->dat_drv);
		break;
	case 1:
	default:
