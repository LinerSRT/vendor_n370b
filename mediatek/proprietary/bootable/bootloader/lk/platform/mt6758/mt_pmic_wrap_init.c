...
static signed int _pwrap_init_sistrobe(int dual_si_sample_settings)
{
	...
	clk_edge_no = (int)((float)(si_en_sel * 2 + si_ck_sel) * CLK_26M_PRD / CLK_ULPOSC_PRD + 0.5);
...
signed int pwrap_init(void)
{
	...
	/* For dual pmic used */
#if 0 /* MT6355 should not need adjust driving current */
#define PWRAP_GPIO_DRIVING_ADDR  0x11C100B0
	WRAP_WR32(PWRAP_GPIO_DRIVING_ADDR, WRAP_RD32(PWRAP_GPIO_DRIVING_ADDR)|(0x1<<0));
	PWRAPLOG("Preloader GPIO228-231 0x11c100b0 driving = 0x%x \n", WRAP_RD32(PWRAP_GPIO_DRIVING_ADDR));
	PWRAPLOG("Preloader GPIO228-231 0x102d04c0 driving = 0x%x \n", WRAP_RD32(0x102d04c0));
	PWRAPLOG("Preloader GPIO228-231 0x102d0070 driving = 0x%x \n", WRAP_RD32(0x102d0070));
	PWRAPLOG("Preloader GPIO228-231 0x102d0170 driving = 0x%x \n", WRAP_RD32(0x102d0170));
	PWRAPLOG("Preloader GPIO228-231 0x102d0270 driving = 0x%x \n", WRAP_RD32(0x102d0270));
	PWRAPLOG("Preloader GPIO228-231 0x11c10060 driving = 0x%x \n", WRAP_RD32(0x11c10060));
	PWRAPLOG("Preloader GPIO228-231 0x11c10080 driving = 0x%x \n", WRAP_RD32(0x11c10080));
	PWRAPLOG("Preloader GPIO228-231 0x11c100b0 driving = 0x%x \n", WRAP_RD32(0x11c100b0));
	PWRAPLOG("Preloader GPIO228-231 0x11c10030 driving = 0x%x \n", WRAP_RD32(0x11c10030));
	PWRAPLOG("Preloader GPIO228-231 0x11c10040 driving = 0x%x \n", WRAP_RD32(0x11c10040));
#endif
	__pwrap_spi_clk_set();
