...
/* CLOCK reg */
#define AUXADC_CG_GATING (CLOCK_BASE+0x24)/* bit30 or bit31 for auxadc*/
#define AUXADC_SET_CG_GATING (CLOCK_BASE+0x54)
#define AUXADC_CLR_CG_GATING (CLOCK_BASE+0x84)
#endif

/* Base addr will modify by platfrom */
#define AUXADC_BASE 0x10310000/* mt6758 base addr */
/* AUXADC reg */
