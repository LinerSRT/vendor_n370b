...
#define IO_CFG_1_BASE       (0x10470000)
#define IO_CFG_6_BASE       (0x10460000)
#define IO_CFG_5_BASE       (0x104A0000)
#define IO_CFG_4_BASE       (0x10410000)
#define IO_CFG_3_BASE       (0x10420000)
...
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 root=/dev/ram androidboot.hardware=mt6758 firmware_class.path=/vendor/firmware"
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT3,921600n1 root=/dev/ram vmalloc=496M slub_max_order=0 slub_debug=OFZPU androidboot.hardware=mt6758 firmware_class.path=/vendor/firmware"
#endif
