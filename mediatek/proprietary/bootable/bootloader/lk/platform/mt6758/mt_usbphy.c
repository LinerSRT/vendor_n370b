...
void setting_ref_clk_e60802(void)
{
	 ...
	 * DA_SSUSB_XTAL_EXT_EN[1:0]   | 2'b01-->2'b10       | 0x10440c00 bit[11:10]
	 * DA_SSUSB_XTAL_RX_PWD[9:9]   | -->1'b1             | 0x10440018 bit[9]
	 */
	...
	// For MT6758
	val = readl(U3D_SPLLC_XTALCTL3) & ~E60802_RG_SSUSB_FRC_XTAL_RX_PWD;
	val |= ((0x01) << E60802_RG_SSUSB_FRC_XTAL_RX_PWD_OFST) & E60802_RG_SSUSB_FRC_XTAL_RX_PWD;
	writel(val, U3D_SPLLC_XTALCTL3);

	val = readl(U3D_U3PHYA_DA_REG36) & ~E60802_RG_SSUSB_DA_SSUSB_PLL_BAND;
	val |= ((0x2D) << E60802_RG_SSUSB_DA_SSUSB_PLL_BAND_OFST) & E60802_RG_SSUSB_DA_SSUSB_PLL_BAND;
	writel(val, U3D_U3PHYA_DA_REG36);

	val = readl(U3D_B2_PHYD_RXDET2) & ~E60802_RG_SSUSB_RXDET_STB2_SET_P3;
	val |= ((0x10) << E60802_RG_SSUSB_RXDET_STB2_SET_P3_OFST) & E60802_RG_SSUSB_RXDET_STB2_SET_P3;
	writel(val, U3D_B2_PHYD_RXDET2);

	val = readl(U3D_U3PHYA_DA_REG32) & ~E60802_RG_SSUSB_LFPS_DEGLITCH_U3;
	val |= ((0x01) << E60802_RG_SSUSB_LFPS_DEGLITCH_U3_OFST) & E60802_RG_SSUSB_LFPS_DEGLITCH_U3;
	writel(val, U3D_U3PHYA_DA_REG32);
	// For MT6758
