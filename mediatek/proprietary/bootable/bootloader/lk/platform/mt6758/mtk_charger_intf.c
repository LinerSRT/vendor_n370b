...
rt9466_probe, rt9467_probe, rt9468_probe, mt6370_chg_probe,};
...
int mtk_charger_enable_charging(struct mtk_charger_info *mchr_info, bool enable)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_get_ichg(struct mtk_charger_info *mchr_info, unsigned int *ichg)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_set_ichg(struct mtk_charger_info *mchr_info, unsigned int ichg)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_get_aicr(struct mtk_charger_info *mchr_info, unsigned int *aicr)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_set_aicr(struct mtk_charger_info *mchr_info, unsigned int aicr)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_set_mivr(struct mtk_charger_info *mchr_info, unsigned int mivr)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_enable_power_path(struct mtk_charger_info *mchr_info, bool enable)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
...
int mtk_charger_reset_pumpx(struct mtk_charger_info *mchr_info, bool reset)
{
	MTK_CHG_CHECK_INFO_OPS(mchr_info, mchr_info->mchr_ops);
