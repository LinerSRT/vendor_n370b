...
#define SMI_LARB1_ADDR 0x14018000
#define SMI_COMMON_ADDR 0x14019000
#define SMI_MMSYS_ADDR 0x14000000

#define SMI_DEBUG_LEVEL 0
#define SMIMSG(fmt, args...) dprintf(CRITICAL, "[SMI]"fmt, ##args)
...
#define SMI_MASTER_SETTING_NUM 3
#define SMI_LARB0_REG_NUM 9
#define SMI_LARB1_REG_NUM 9
#define SMI_COMMON_REG_NUM 6
...
static struct smi_reg_info smi_larb0_reg[SMI_LARB0_REG_NUM] = {
	{0x24, 0x370223}, {0x40, 0x1}, {0x80, 0xfffffff0}, {0x100, 0xb},
	{0x104, 0xb}, {0x108, 0xb}, {0x380, 0x3}, {0x384, 0x3}, {0x388, 0x3}
};

static struct smi_reg_info smi_larb1_reg[SMI_LARB1_REG_NUM] = {
	{0x24, 0x370223}, {0x40, 0x1}, {0x80, 0xfffffff0}, {0x100, 0xb},
	{0x104, 0xb}, {0x108, 0xb}, {0x380, 0x3}, {0x384, 0x3}, {0x388, 0x3}
};

static struct smi_reg_info smi_common_reg[SMI_COMMON_REG_NUM] = {
	{0x100, 0xb}, {0x104, 0x18bc}, {0x108, 0x15d3}, {0x234, 0xe100e10},
	{0x300, 0x4f1}, {0x444, 0x1}
};
...
static struct smi_master_info smi_regs[SMI_MASTER_SETTING_NUM] = {
	...
	{SMI_LARB1_ADDR, SMI_LARB1_REG_NUM, smi_larb1_reg}
};
