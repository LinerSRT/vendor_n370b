...
#define MPU_REGION_ID_MD1_SEC_SMEM      8
#define MPU_REGION_ID_MD3_SEC_SMEM      9

#define MPU_REGION_ID_MD1_SMEM          10
#define MPU_REGION_ID_MD3_SMEM          11
#define MPU_REGION_ID_MD1MD3_SMEM       12
#define MPU_REGION_ID_MD1_MCURW_HWRW    13
#define MPU_REGION_ID_MD1_ROM           14  /* contain DSP in Jade */
#define MPU_REGION_ID_MD1_MCURW_HWRO    15
#define MPU_REGION_ID_MD1_MCURO_HWRW    16
#define MPU_REGION_ID_WIFI_EMI_FW       17
#define MPU_REGION_ID_WMT               18
#define MPU_REGION_ID_MD1_CCB           19
#define MPU_REGION_ID_MD3_CCB           20
...
#define MPU_REGION_ID_MD_DYNAMIC        29
...
static const unsigned int mpu_att_default[MPU_REGION_ID_TOTAL_NUM][MPU_MDOMAIN_ID_TOTAL_NUM] = {
	...
	/* 3*/{ FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , SEC_RW,    FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in TEE Trust UI*/
	/* 4*/{ NO_PROTECTION, FORBIDDEN    , FORBIDDEN    , NO_PROTECTION, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in TEE MD1 SEC MEM*/
    /* 5*/{ FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , SEC_R_NSEC_R,  FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Tinysys-SCP ROM*/
	/* 6*/{ NO_PROTECTION, FORBIDDEN    , FORBIDDEN    , NO_PROTECTION, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Tinysys-SCP share buffer*/
	/* 7*/{ SEC_RW       , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN}, /*Set in TEE MD1 SEC MEM*/
	/* 8*/{ SEC_RW       , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN}, /*Set in TEE MD1 SEC MEM*/
	/* 9*/{ SEC_RW       , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN,     FORBIDDEN    , FORBIDDEN}, /*Set in TEE MD1 SEC MEM*/
	/*10*/{ NO_PROTECTION, NO_PROTECTION, FORBIDDEN    , NO_PROTECTION, FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK CCCI_MD1*/
	/*11*/{ NO_PROTECTION, FORBIDDEN    , FORBIDDEN    , NO_PROTECTION, FORBIDDEN    , NO_PROTECTION, FORBIDDEN    , FORBIDDEN}, /*Set in LK CCCI_MD3*/
	/*12*/{ NO_PROTECTION , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , NO_PROTECTION, FORBIDDEN    , FORBIDDEN},/*Set in LK MD1_MD3*/
	/*13*/{ SEC_R_NSEC_R , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN, NO_PROTECTION}, /*Set in LK MD1_MCURW_HWRW*/
	/*14*/{ SEC_R_NSEC_R , SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN, SEC_R_NSEC_R }, /*Set in LK MD1_ROM_DSP*/
	/*15*/{ SEC_R_NSEC_R , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN, SEC_R_NSEC_R }, /*Set in LK MD1_MCURW_HWRO*/
	/*16*/{ SEC_R_NSEC_R , SEC_R_NSEC_R, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN, NO_PROTECTION}, /*Set in LK MD1_MCURO_HWRW*/
	/*17*/{ FORBIDDEN    , FORBIDDEN    , NO_PROTECTION, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in Kernel WIFI EMI FW*/
	/*18*/{ NO_PROTECTION, FORBIDDEN    , NO_PROTECTION, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in Kernel WMT*/
	/*19*/{ NO_PROTECTION , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN, NO_PROTECTION }, /*Set in MD1_CCB*/
	/*20*/{ NO_PROTECTION , FORBIDDEN, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , NO_PROTECTION    , FORBIDDEN, FORBIDDEN }, /*Set in MD3_CCB*/
	/*21*/{ SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN    , FORBIDDEN, FORBIDDEN    , SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD3 ROM*/
	/*22*/{ SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN    , FORBIDDEN, FORBIDDEN, NO_PROTECTION    , FORBIDDEN, FORBIDDEN}, /*Set in LK MD3 R/W*/
	/*23*/{ NO_PROTECTION, NO_PROTECTION , FORBIDDEN   , FORBIDDEN, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD Padding1*/
	/*24*/{ NO_PROTECTION, NO_PROTECTION , FORBIDDEN   , FORBIDDEN, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD Padding2*/
	/*25*/{ NO_PROTECTION, NO_PROTECTION , FORBIDDEN   , FORBIDDEN, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD Padding3*/
	/*26*/{ NO_PROTECTION, NO_PROTECTION , FORBIDDEN   , FORBIDDEN, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD Padding4*/
	/*27*/{ NO_PROTECTION, NO_PROTECTION , FORBIDDEN   , FORBIDDEN, FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD Padding5*/
	/*28*/{ NO_PROTECTION, SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN, NO_PROTECTION, FORBIDDEN    , NO_PROTECTION    , FORBIDDEN}, /*Set in LK MD Protect*/
	/*29*/{ FORBIDDEN    , NO_PROTECTION, FORBIDDEN    , FORBIDDEN, FORBIDDEN    , FORBIDDEN    , FORBIDDEN    , FORBIDDEN}, /*Set in LK MD dynamic*/
	/*30*/{ NO_PROTECTION, SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN, NO_PROTECTION, FORBIDDEN    , NO_PROTECTION, FORBIDDEN},/*Set in Kernel AP*/
	/*31*/{ NO_PROTECTION, SEC_R_NSEC_R , FORBIDDEN    , FORBIDDEN, NO_PROTECTION, FORBIDDEN    , NO_PROTECTION, FORBIDDEN},/*Set in Kernel AP*/
}; /*=================================================================================================================*/
...
static unsigned int get_mpu_region_default_access_att(int region, int lock)
{
	...
	return SET_ACCESS_PERMISSON(lock,
...
static unsigned int mpu_attr_calculate(int region_id, unsigned int request_attr)
{
	...
	return  SET_ACCESS_PERMISSON(1,
			FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN,
	                                 FORBIDDEN, FORBIDDEN, FORBIDDEN,
			tmp_mpu_att[7], tmp_mpu_att[6], tmp_mpu_att[5], tmp_mpu_att[4],
...
static void ccci_mem_access_cfg(mpu_cfg_t *mpu_cfg_list, int clear)
{
	...
	curr_attr = SET_ACCESS_PERMISSON(0,
			FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN, FORBIDDEN,
	                                 FORBIDDEN, FORBIDDEN, FORBIDDEN,
