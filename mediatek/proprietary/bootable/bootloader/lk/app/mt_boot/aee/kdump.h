...
/* for ext4, InfoLBA (header), version 1
 * support allocate size > 4G
 */
#define MRDUMP_PAF_SIZE 32
#define MRDUMP_LBA_DATAONLY 28
#define MRDUMP_PAF_VERSION 0x0001
#define MRDUMP_PAF_INFO_LBA      4
#define MRDUMP_PAF_ADDR_LBA      8
#define MRDUMP_PAF_ALLOCSIZE    12
#define MRDUMP_PAF_COREDUMPSIZE 20
#define MRDUMP_PAF_CRC32        28
...
int kdump_usb_output(const struct mrdump_control_block *mrdump_cb, const struct kzip_memlist *memlist);
