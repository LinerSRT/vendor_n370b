...
extern void DSI_clk_HS_mode(DISP_MODULE_ENUM module, cmdqRecHandle cmdq, bool enter);
...
static void init_lcm_registers(void)
{
	...
	data_array[2] = 0x00005101;	/* 0x00005501@66.6fps, 0x00005401@65fps, 0x00005101@63fps */
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	/* 750@66.6, 744@66, 733@65fps, 710@63fps, 700fps, 338@30fps, 564@50fps, 676@60fps; */
